...
return [
    ...
    'payment' => [
        ...
        'cert_path'          => base_path() . env('WECHAT_PAYMENT_CERT_PATH', '/path/to/your/cert.pem'), // XXX: 绝对路径！！！！
        'key_path'           => base_path() . env('WECHAT_PAYMENT_KEY_PATH', '/path/to/your/key'),      // XXX: 绝对路径！！！！
